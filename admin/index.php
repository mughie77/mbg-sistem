    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="index.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group bg-gray-100">
                ...
                <li>
                    <a href="reports.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
        ...
        <div class="p-4 mt-14">
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_class'])) {
                ...
                echo '<div id="alert-3" class="flex items-center p-4 mb-4 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
                    ...
                    <div class="ms-3 text-sm font-medium">Kelas berhasil ditambahkan!</div>
                  </div>';
            }
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Daftar Kelas</h1>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Kelola data kelas, wali kelas, dan jumlah siswa.</p>
                </div>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white"><?= htmlspecialchars($class['name']) ?></td>
                            <td class="px-6 py-4"><?= htmlspecialchars($class['homeroom_teacher']) ?></td>
                            <td class="px-6 py-4 text-center"><?= $class['total_students'] ?></td>
                            <td class="px-6 py-4">
                                <form method="POST" onsubmit="return confirm('Hapus kelas ini?')">
                                    <input type="hidden" name="id" value="<?= $class['id'] ?>">
                                    <button type="submit" name="delete_class" class="font-medium text-red-600 dark:text-red-500 hover:underline">Hapus</button>
                                </form>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                ...
                <form class="p-4 md:p-5" method="POST">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            ...
                            <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Contoh: XII RPL 1" required="">
                        </div>
                        <div class="col-span-2">
                            <label for="homeroom_teacher" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Wali Kelas</label>
                            <input type="text" name="homeroom_teacher" id="homeroom_teacher" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Nama Lengkap Wali Kelas" required="">
                        </div>
                        <div class="col-span-2">
                            <label for="total_students" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jumlah Siswa</label>
                    ...
                    <button type="submit" name="add_class" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
